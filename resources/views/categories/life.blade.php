...
@include('inc.nav')
 ...
 <div>
       <div
        class="container-fluid page-header-life py-5 mb-3 wow fadeIn"
        data-wow-delay="0.1s"
      >
        <div class="container py-5">
          <h1 class="display-4 animated slideInDown mb-4 text-center" style= "color:white" >Life Insurance </h1>
